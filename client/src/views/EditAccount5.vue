    ...
    <div class="parent-container">
      <div class="body">
          <div class="profile-window">
            ...
            <div class="main-box">
              <img src="../assets/img/StephanieMorgan.png" alt="Stephanie Morgan Profile" />
              ...
              <div class="">
                <div class="info">
                  <div>
                    <h3>Username</h3>
                    <input class="input" type="text" value="Stephanie Morgan">
                  </div>
                  <div>
                    <h3>Email</h3>
                    <input class="input" type="text" value="Stephanie.Morgan@gmail.com">
                  </div>
                  <div>
                    <h3>Status</h3>
                    <textarea class="text-area">
Freelance web specialist. Pop culture guru. Foodaholic. Twitter junkie. Problem solver. Beer maven.
                    </textarea>
                  </div>
                </div>

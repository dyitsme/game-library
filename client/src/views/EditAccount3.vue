    ...
    <div class="parent-container">
      <div class="body">
          <div class="profile-window">
            ...
            <div class="main-box">
              <img src="../assets/img/GloriaMorris.png" alt="Gloria Morris Profile" />
              ...
              <div class="">
                <div class="info">
                  <div>
                    <h3>Username</h3>
                    <input class="input" type="text" value="Gloria Morris">
                  </div>
                  <div>
                    <h3>Email</h3>
                    <input class="input" type="text" value="Gloria.Morris@gmail.com">
                  </div>
                  <div>
                    <h3>Status</h3>
                    <textarea class="text-area">
Entrepreneur. Tv fan. Explorer. Food scholar. Music specialist. Professional bacon guru. Gamer.
                    </textarea>
                  </div>
                </div>
